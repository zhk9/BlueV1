...
public class Client_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View myView = inflater.inflate(R.layout.fragment_client_, container, false);
...
//        });
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            if (socket != null) {
                startActivity(new Intent(getActivity(), SecodService.class));
                mkmsg("Connection made\n");
                mkmsg("Remote device address: "+socket.getRemoteDevice().getAddress()+"\n");
                Log.d("zhk2","loop"+ socket.getRemoteDevice().getName()+"\n");
